...
int main()
{
	...
	arr.Fill(5, 25);
	std::cout << "Filled in range [5, 25]:\n" << arr << std::endl;
	arr.FillAscending(5, 25);
	std::cout << "Filled in ascending order in range [5, 25]:\n" << arr << std::endl;
	arr.FillDescending(5, 25);
	std::cout << "Filled in descending order in range [5, 25]:\n" << arr << std::endl;
